...
class KartozaAdminSite(AdminSite):
    """
    Custom Django AdminSite for the Kartoza project.
    ...
    site_header = "Kartoza Administration"
    site_title = "Kartoza Admin"
    site_url = settings.LOGIN_REDIRECT_URL


admin_site = KartozaAdminSite(name="kartoza_admin")
